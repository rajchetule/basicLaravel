                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('education-edit', ['id' => $education->id])  }}" class="btn btn-outline-success btn-sm btn-flat">Edit</a>
                                        <a href="{{ url('education-delete/'.$education->id) }}" class="btn btn-outline-danger btn-sm btn-flat">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
